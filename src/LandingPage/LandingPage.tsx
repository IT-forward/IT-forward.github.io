...
function LandingPage() {
    return (
        <Container id="body">
            <header>
                <Navbar collapseOnSelect expand="md" className="px-0 mt-2" id="navbar">
                    <Navbar.Brand href="#">
                    ...
                    <Navbar.Collapse className="justify-content-end" id="responsive-navbar-nav">
                        <Nav>
                            <Nav.Link href="#" id="nav-link-1" className="px-0 text-right">Navigation</Nav.Link>
                            <Nav.Link href="#" id="nav-link-2" className="px-0 text-right">Navigation</Nav.Link>
                            <Nav.Link href="#" id="nav-link-3" className="px-0 text-right mr-0">Navigation</Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Navbar>
            ...
            <footer>
                <Row className="px-2">
                    <Col sm={12} md={3} lg={3} className="d-flex align-items-center justify-content-center justify-content-md-start">
